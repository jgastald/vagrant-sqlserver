...
# echo "deb [arch=amd64] https://packages.microsoft.com/ubuntu/16.04/prod xenial main" | sudo tee /etc/apt/sources.list.d/mssql.lis
...
sudo apt-get install -y -q mssql-tools unixodbc-dev
# # Clean up
